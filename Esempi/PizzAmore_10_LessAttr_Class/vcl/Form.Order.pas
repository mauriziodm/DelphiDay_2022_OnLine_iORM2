...
type
  TOrderForm = class(TForm)
    ...
    procedure DSRowsSelectionObject(const ASender: TObject; var ASelected: TObject; var ASelectionType: TioSelectionType; var ADone: Boolean);
...
procedure TOrderForm.DSRowsSelectionObject(const ASender: TObject; var ASelected: TObject; var ASelectionType: TioSelectionType; var ADone: Boolean);
begin
  ASelected := TOrderRow.Create(ASelected as TPizza);
end;

{$region 'AddPizza (smartest) (target := DSOrder)'}
